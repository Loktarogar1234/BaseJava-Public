...
public class VariablesTheme {
    public static void main(String[] args) {
        ...
        System.out.println(number4 + " " + number4-- + " " + number4++);
         ...
         //объявляем целочисленные переменные a и b (некрасиво, запро просто)
         int a = 2, b = 5;
         
         //меняем местами значения переменных a и b с помощью третьей переменной c
         int c = a;
         a = b;
         b = c;

         //меняем местами значения переменных a и b с помощью арифмектики
         a += b;
         b -= a - b;
         a -= b;
