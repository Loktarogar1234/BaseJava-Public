...
public class Calc {
    public static void main(String[] args) {
        /*
        Да, в задании говорилось "не используйте ввод с клавиатуры — значения выражения присвойте переменным прямо в коде"
        так не интересно и пошло. Ну иначе это не калькулятор!
        a = 10;
        b = 2;
        char sign = '/';
        */
        ...
        int a = scan.nextInt(); //если ввести нецелое число, вылетит с ошибкой
        scan.nextLine();   //здесь и далее очистка буфера ввода, иначе после ввода b вылетает с ошибкой
        ...
        float result = 1; //при делении целых чисел результат может быть дробным
        if (sign == '+') {
            result = a + b;
        } else if (sign == '-') {
            result = a - b;
